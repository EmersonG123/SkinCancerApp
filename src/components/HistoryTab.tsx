...
import { Search, Filter, Trash2, Calendar, FileText, ExternalLink, RefreshCw, AlertCircle, AlertTriangle } from "lucide-react";
...
export default function HistoryTab({ records, onDeleteRecord, onSelectRecord, historyError }: HistoryTabProps) {
  ...
  return (
    <div className="w-full flex flex-col gap-6 font-sans">
      ...
      {historyError && (
        <div className="p-4 bg-red-500/10 text-red-400 border border-red-500/30 rounded-xl font-mono text-xs flex gap-3 items-start shadow-[0_0_15px_rgba(239,68,68,0.1)]">
          <AlertTriangle className="w-5 h-5 text-red-400 flex-shrink-0 animate-bounce" />
          <div>
            <strong className="block text-[13px] uppercase tracking-wider mb-1">Error de Comunicación del Historial:</strong>
