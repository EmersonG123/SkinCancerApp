  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const newUser: UserType = {
        ...
        email: email,
        license: license,
        specialty: specialtyLabels[specialty] || "Dermatología Clínica",
        analyses: 0,
        precision: 98 // base baseline clinical accuracy
      };

      // Save in users array in local storage for persistence
